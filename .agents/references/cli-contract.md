...
- Optional input:
  ...
  - Compose plan: `--context <path>`, `--server <id|name>`, `--compose-override <path>` repeatable in order, `--profile <name>` repeatable, `--json`
