...
| `server:write`     | `registerServer`, `deleteServer`, `previewServerCleanup`, `runServerCleanup`, `planServerPatches`, `createManagedTunnel`, `updateManagedTunnel`, `syncManagedTunnelRoutes`, `rotateManagedTunnelCredentials`, `deleteManagedTunnel`, `createLogDrain`, `deleteLogDrain`, `testLogDrain`, `retryLogDrainDelivery` |
